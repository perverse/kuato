...
use Kuato\Contracts\ModuleServiceInterface;
use Kuato\Containers\JsonCollection as Collection;
use Kuato\Containers\Json;
use Kuato\Exceptions\ModuleNotFoundException;
...
class ModuleService implements ModuleServiceInterface
{
    ...
    {
        return $this->app['config']->get('kuato.'.$key);
    }
